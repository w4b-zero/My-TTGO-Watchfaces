...
curl https://raw.githubusercontent.com/w4b-zero/PG-TTGO-Watchfaces/main/watchface_theme_list.json > w4b-zero.json
github_repos | jq --tab -s '(.[0] + .[1] + .[2]) | sort_by(.name)' local_watchface_theme_list.json w4b-zero.json - > watchface_theme_list.json
